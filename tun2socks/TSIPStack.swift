...
public final class TSIPStack {
    ...
    public func resumeTimer() {
        timer = DispatchSource.makeTimerSource(flags: DispatchSource.TimerFlags(rawValue: UInt(0)), queue: processQueue)
        // note the default tcp_tmr interval is 250 ms.
        timer?.scheduleRepeating(deadline: .now() + .milliseconds(250), interval: .milliseconds(250), leeway: .seconds(1))
